...
import { BANKS_REF, BANK_REF } from "../constants";
...
// export const parseBankData1 = async (ref: string) => {
//   try {
//     const reportsLinkHtml = await axios.get(ref);
...
// export const parseAllBanksData = ()=>{
//   const a = Object.entries(BANKS_REF).map(())
